...
def show_dots_plot():
  ...
  st.markdown('''This chart can be a good alternative to the traditional bar chart to show the composition of a sample within a population.
